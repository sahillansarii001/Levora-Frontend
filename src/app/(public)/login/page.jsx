...
export default function UnifiedLogin() {
  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-slate-50 via-white to-slate-50 pt-24 pb-12 px-4 relative overflow-hidden">
      ...
      <div className="relative bg-white p-8 md:p-10 rounded-3xl shadow-2xl w-full max-w-md border border-slate-100 overflow-hidden">
        ...
        <div className="relative z-10 text-center mb-10">
          ...
          />
          <div className="inline-flex items-center gap-2 bg-gradient-to-r from-[var(--color-gold)]/10 to-[var(--color-gold-dark)]/10 px-4 py-1.5 rounded-full text-xs font-bold text-[var(--color-gold)] border border-[var(--color-gold)]/20 mb-5">
            <Sparkles size={12} />
            <span>Student Portal</span>
          </div>
          <h2 className="text-3xl font-bold font-poppins text-[var(--color-navy)] mb-2">Welcome Back</h2>
          <p className="text-slate-500">Sign in to your account</p>
        </div>

        <form className="relative z-10 space-y-5" onSubmit={handleLogin}>
          <div>
            <label className="block text-sm font-bold text-slate-700 mb-2">Email / Student ID</label>
            <div className="relative">
              ...
              <input 
                ...
                className="w-full pl-11 pr-4 py-3.5 rounded-xl border border-slate-200 focus:border-[var(--color-gold)] focus:ring-2 focus:ring-[var(--color-gold)]/20 outline-none transition-all bg-slate-50 focus:bg-white" 
          ...
          <button 
            type="submit" 
            disabled={loading}
            className="btn-primary w-full flex justify-center items-center h-12 text-base mt-2"
          >
