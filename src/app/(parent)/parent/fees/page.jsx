...
export default function ParentFeesPage() {
  ...
  const fetchFees = async () => {
    ...
    try {
      ...
      const res = await fetch(`${process.env.NEXT_PUBLIC_API_URL || 'http://localhost:5000/api'}/parent/child/fees`, {
  ...
  return (
    <div className="pt-8 bg-slate-50 min-h-screen pb-12">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        {/* Header */}
        <div className="mb-8">
          <h1 className="text-2xl font-bold text-slate-900 font-poppins tracking-tight">Fee Payments</h1>
          <p className="text-sm text-slate-500 mt-1">View your child's payment history and upcoming dues.</p>
        </div>
