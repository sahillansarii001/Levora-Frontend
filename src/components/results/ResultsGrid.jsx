    ...
    <section className="pt-28 pb-28 bg-white min-h-screen relative overflow-hidden">
      <div className="container mx-auto px-4 md:px-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-5 mb-20 mt-4 max-w-4xl mx-auto">
          <div className="relative gradient-bg p-8 rounded-2xl text-center text-white shadow-xl hover:-translate-y-1 transition-all duration-500 overflow-hidden group">
            <div className="absolute top-0 right-0 w-32 h-32 bg-[var(--color-gold)]/10 rounded-full blur-2xl pointer-events-none" />
            <Trophy size={44} className="mx-auto mb-4 text-[var(--color-gold)] group-hover:scale-110 transition-transform duration-500" />
            <h3 className="text-4xl font-bold font-poppins mb-2 text-[var(--color-gold)]">250+</h3>
            <p className="text-slate-300 font-medium">Students scored above 95% in Board Exams</p>
          </div>
          <div className="relative bg-gradient-to-r from-[var(--color-gold)] to-[var(--color-gold-dark)] p-8 rounded-2xl text-center text-[var(--color-navy)] shadow-xl hover:-translate-y-1 transition-all duration-500 overflow-hidden group">
            <div className="absolute top-0 right-0 w-32 h-32 bg-white/10 rounded-full blur-2xl pointer-events-none" />
            <Medal size={44} className="mx-auto mb-4 text-[var(--color-navy)] group-hover:scale-110 transition-transform duration-500" />
            <h3 className="text-4xl font-bold font-poppins mb-2 text-[var(--color-navy)]">150+</h3>
            <p className="text-[var(--color-navy)]/80 font-medium">IIT & NIT Selections in 2024</p>
          </div>
          <div className="relative bg-gradient-to-br from-[var(--color-sky)] to-[var(--color-emerald)] p-8 rounded-2xl text-center text-white shadow-xl hover:-translate-y-1 transition-all duration-500 overflow-hidden group">
            <div className="absolute top-0 right-0 w-32 h-32 bg-white/10 rounded-full blur-2xl pointer-events-none" />
